...
"[project]/node_modules/@imagekit/next/dist/server/index-esm.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "getUploadAuthParams": (()=>getUploadAuthParams)
});
 ...
 */ const getUploadAuthParams = function({ token, expire, publicKey, privateKey }) {
    ...
    const authResponse = {
        token: token || __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomUUID(),
        expire: expire || defaultExpire
    };
    const signature = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHmac("sha1", privateKey).update(authResponse.token + String(authResponse.expire)).digest("hex");
    return {
...
"[project]/node_modules/next/dist/esm/build/templates/app-route.js { INNER_APP_ROUTE => \"[project]/src/app/api/upload-auth/route.ts [app-route] (ecmascript)\" } [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$upload$2d$auth$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/upload-auth/route.ts [app-route] (ecmascript)");
;
;
;
;
...
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$app$2d$route$2f$module$2e$compiled$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppRouteRouteModule"]({
    definition: {
        ...
        page: "/api/upload-auth/route",
        pathname: "/api/upload-auth",
        filename: "route",
        bundlePath: ""
    },
    resolvedPagePath: "[project]/src/app/api/upload-auth/route.ts",
    nextConfigOutput,
    userland: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$upload$2d$auth$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
});
...
//# sourceMappingURL=node_modules_d6060cad._.js.map